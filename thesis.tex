...
% 英語タイトル
\def\etitle{Overall Mobility Control According to Human Satisfaction}
% 著者(日本語)
\def\author{島津翔太}
% 著者(英語)
...
% 学部・研究科(英語)
\def\edept{Faculty of Environment and Information Studies, Keio Universtiy}
